                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-[#60758a] text-sm leading-relaxed">Encuentra el video de TikTok que quieres guardar y copia su URL desde el menú de compartir.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-[#60758a] text-sm leading-relaxed">Pega el enlace en el campo de entrada en la parte superior de esta página.</p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="text-[#60758a] text-sm leading-relaxed">Haz clic en el botón de descarga y elige tu formato preferido.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="layout-content-container flex flex-col lg:flex-row gap-8 max-w-[960px] flex-1">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex gap-4 p-4 rounded-xl bg-white border border-[#e5e7eb] shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-[#60758a] text-sm">Videos limpios sin el logo de TikTok o la superposición del nombre de usuario.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 p-4 rounded-xl bg-white border border-[#e5e7eb] shadow-sm">
                        <div class="text-primary mt-1">
                    ...
                    <div class="flex gap-4 p-4 rounded-xl bg-white border border-[#e5e7eb] shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-[#60758a] text-sm">Completamente gratis para usar sin necesidad de registro o inicio de sesión.</p>
                        </div>
                    </div>
                    <div class="flex gap-4 p-4 rounded-xl bg-white border border-[#e5e7eb] shadow-sm">
                        <div class="text-primary mt-1">
            ...
            <div class="w-full lg:w-[300px] flex-shrink-0 flex flex-col gap-4">
                ...
                <div class="p-4 bg-primary/5 rounded-xl border border-primary/10">
                    ...
                    <p class="text-xs text-[#60758a]">También puedes descargar solo el audio MP3 si solo quieres la música!</p>
                </div>
            </div>
        </div>
    </div>
